    ...
    <>
      <div className='shadow-2xl min-h-screen h-[100vh] overflow-auto z-50 fixed bg-white'>
        <div className='w-80 pl-3 pr-3 pt-3 pb-6 flex flex-col gap-3'>
          <button className="hover:bg-gray-200 collapse collapse-content cursor-pointer py-3 text-2xl font-medium items-center flex gap-2">
            <span className='bg bg-primary text-white rounded-xl text-base p-2'>DW</span>DashWind
          </button>

          <div className='rounded-box w-full'>
            <button className="hover:bg-gray-300 collapse collapse-content p-3 cursor-pointer text-sm font-medium items-center flex gap-2">
            ...
            <div tabIndex={0} className="collapse collapse-arrow hover:bg-gray-300">
              <input type="checkbox" />
            ...
            <div tabIndex={0} className="collapse collapse-arrow hover:bg-gray-200">
              <input type="checkbox" />
              <div className="collapse-title text-md font-medium items-center flex gap-2">
